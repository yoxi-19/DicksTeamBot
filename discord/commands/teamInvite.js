...
export default {
  ...
  async execute(interaction) {
    ...
    await interaction.reply({
      embeds: [successEmbed('Einladung gesendet', `Die Team-Einladung für **${ign}** wurde im Spiel ausgeloest.`)],
      ephemeral: true,
    });

    logger.info(`[Discord] Admin ${interaction.user.tag} hat Team-Einladung für ${ign} gesendet.`);
  },
};